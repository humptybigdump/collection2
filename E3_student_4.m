...
idx_event_end = 'INSERT CALCULATION OF MOVING SUM OF constant_k_gradient AND FIND POSITION IN ARRAY WHERE VALUES IS 3';
...
recession1_duration_schwebich = 'INSERT ARRAY FROM 1 TO LENGTH OF recession1_idx_schwebich';
...
recession2_duration_schwebich = 'INSERT ARRAY FROM 1 TO LENGTH OF recession2_idx_schwebich';
...
recession3_duration_schwebich = 'INSERT ARRAY FROM 1 TO LENGTH OF recession3_idx_schwebich';
...
recession1_duration_colpach = 'INSERT ARRAY FROM 1 TO LENGTH OF recession1_idx_colpach';
...
recession2_duration_colpach = 'INSERT ARRAY FROM 1 TO LENGTH OF recession2_idx_colpach';
...
recession3_duration_colpach = 'INSERT ARRAY FROM 1 TO LENGTH OF recession3_idx_colpach';
...
% recession phases
    runoff_recession_phases_schwebich = 'INSERT INDEXING OF ACTUAL RUNOFF VALUES IN ENTIRE OBSERVED PERIOD BY USING THE ABOVE DEFINED INDEX';

% use these positions/index to select the runoff changes dQ/dt of the
% recession phases
    dQ_dt_recession_phases_schwebich = 'INSERT INDEXING OF dQ/dt BY USING THE ABOVE DEFINED INDEX';
...
% Colpach (same as for Schwebich)
    ...
    runoff_recession_phases_colpach = 'INSERT INDEXING OF ACTUAL RUNOFF VALUES IN ENTIRE OBSERVED PERIOD BY USING THE ABOVE DEFINED INDEX';
    dQ_dt_recession_phases_colpach = 'INSERT INDEXING OF dQ/dt BY USING THE ABOVE DEFINED INDEX';
