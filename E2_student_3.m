...
% manually select first date in first line as center of drought period (see meaning
% of "movsum")
dates_drought_colpach = dn(drought_idx_colpach);

% manually select drought event based on first date in array
% "dates_drought_copach"
    drought_begin_colpach = datetime('INSERT YEAR', 'INSERT MONTH', 'INSERT DAY', 00, 00, 00);   % manually select drought begin: 15 days before first date in array "dates_drought_copach"
    drought_end_colpach = datetime('INSERT YEAR', 'INSERT MONTH', 'INSERT DAY', 00, 00, 00);     % manually select drought end: 15 days after first date in array "dates_drought_copach"
