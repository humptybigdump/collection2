...
Beeren <- read_csv2("41232-0002_$F.csv", skip = 7, n_max = 28) 


# Die fehlenden Werte (NA) werden noch nicht korrekt angezeigt
Beeren <- read_csv2("41232-0002_$F.csv", skip = 7, n_max = 28, col_names = FALSE, locale = locale(encoding = "latin1"))
view(Beeren)

# korrekte Variante
Beeren <- read_csv2("41232-0002_$F.csv", 
                    skip = 7, # die ersten 7 Zeilen werden uebersprungen
                    n_max = 308, # es werden nur 280 Zeilen eingelesen
