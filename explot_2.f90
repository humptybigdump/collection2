...
!23456789.123456789.123456789.123456789.123456789.123456789.123456789.12
      IMPLICIT NONE
      CHARACTER*500 REC
      CHARACTER*32 FONTNAME
      CHARACTER*3 ABC
      REAL*8 X0,Y0,B,H,L,R,U,O,S,FAT, &
      LGRAY,FGRAY,LCOLR,LCOLG,LCOLB,FCOLR,FCOLG,FCOLB
      INTEGER*4 SYSTEM,STYLE,LINCOL,FILCOL
      COMMON /GLOCH/ REC,FONTNAME,ABC
      COMMON /GLORE/ X0,Y0,B,H,L,R,U,O,S,FAT, &
      LGRAY,FGRAY,LCOLR,LCOLG,LCOLB,FCOLR,FCOLG,FCOLB
      COMMON /GLOIN/ SYSTEM,STYLE,LINCOL,FILCOL
!----- end of common variables
      ...
      DASH1,DASH2,GAP1,GAP2,X99,Y99,SYM99,GR99
      INTEGER*4 COD,II,I001,C1,C2,I1,I2,I3,NID,I,I002,LONGCOD,NPEND
!=====
      CHARACTER*120 wpath,tpath,CPLNAME,FNAME,LOGFNAME
      INTEGER*4 iwpath,itpath
      character filetype(9)*3
      character*30 filelog,filecln,fileps
      character largum(5)*80,sdate*21
      integer ierr,j,larg
      character dir*1, ext*10, os*20
      integer  hlp,kbd,scr,log,cln,plt,rxn,grd,pst
      common /iounits/ hlp,kbd,scr,log,cln,plt,rxn,grd,pst
!-----
      data dir, ext, os /'/',2*' '/
      data largum /5*' '/
      data filetype &
      /'hlp','kbd','scr','log','cln','plt','rxn','grd','pst'/
!=====
!-----
...
!     largum(2) = PostScript file output   ---> unit= pst
!
!-----
      larg=0
      do 400 I=1,5
...
!.....
      ...
      CALL GELI(REC,DASH2)
      CALL GELI(REC,GAP2)
      CALL VPDASH(DASH1,GAP1,DASH2,GAP2)
      GOTO 10
      END IF
!.....
...
!.....
      ...
      CALL TAXI(REC,FONTNAME)
      IF (FONTNAME.EQ.'2') FONTNAME='Helvetica'
      CALL VPNEWFONT(FONTNAME)
      GOTO 10
      END IF
!.....
...
!----- end of common variables
      ...
      INTEGER*4 I,II,I1,I2,I3,LAE,C1,C2
!====
      THETA=0.0D0
      ZERO=0.0D0
      I=I3
...
!----- end of common variables
      ...
      INTEGER*4 I,IPLTR,ISPEED,IAXCOL,NUMLBL,NPOINT,NPL,ISYMB, &
      ICOLPT,ICOLLB,IP(1000),NCHAR,NID,LONGCOD,NPEND
!====
      SYM99=99.0D0
      GR99=0.25D0
      SYM97=97.0D0
...
!     WRITE (6,FMT='(I1,0PE19.11,3(0PE20.12),2F10.4,2I3)')
!    >IPLTR,XMIN,XMAX,YMIN,YMAX,B,H,ISPEED,IAXCOL
      END IF
      IF (B.LE.0.0D0) B=15.0D0
      IF (H.LE.0.0D0) H=15.0D0
...
!
!***************
      SUBROUTINE VPDASH(DASH1,GAP1,DASH2,GAP2)
      IMPLICIT NONE
!
      integer  hlp,kbd,scr,log,cln,plt,rxn,grd,pst
      common /iounits/ hlp,kbd,scr,log,cln,plt,rxn,grd,pst
!
      REAL*8 DASH1,GAP1,DASH2,GAP2
!====
...
!----- end of common variables
      ...
      INTEGER*4 I,I1,CODE,I001,I002,LL
!====
...
!********************************
      ...
      IMPLICIT NONE
      CHARACTER*(*) tag,tpath
      INTEGER*4  hlp,kbd,scr,log,cln,plt,rxn,grd,pst
      common /iounits/ hlp,kbd,scr,log,cln,plt,rxn,grd,pst
      CHARACTER line*130
      CHARACTER*120 FNAME
      INTEGER*4 itpath,j
...
!******************************
      ...
      integer  hlp,kbd,scr,log,cln,plt,rxn,grd,pst
      common /iounits/ hlp,kbd,scr,log,cln,plt,rxn,grd,pst
      data  hlp,kbd,scr,log,cln,plt,rxn,grd,pst &
            / 2,  5,  6, 12, 13, 14, 15, 16, 17/
      end
