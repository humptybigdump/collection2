...
% years (dS = 0). 
% IMPORTANT:In the following, use the above defined NaN index to do all the
% calculations only with actual data and ignoring rows with NaN. You have
% to ignore rows with NaN for each variable/array.
    'INSERT YOUR CODE FOLLOWING THE COMMENT ABOVE'

% Step 2: calculating aridity index of catchment for the entire 45 years
% (Eq. 1): sum of PET / sum of P
    'INSERT YOUR CODE FOLLOWING THE COMMENT ABOVE'

% Step 3: calculating evaporative index of catchment for the entire 45
% years (Eq. 2): sum of AET / sum of P
    'INSERT YOUR CODE FOLLOWING THE COMMENT ABOVE'
...
hold on
% plot of catchment position in budyko framework, x= aridity index , y =
% evaporative index
    'INSERT YOUR CODE FOLLOWING THE COMMENT ABOVE'
...
for k = 1:length(myFiles)
  ...
  % next catchment file k in the previously defined list containing all
  % available files in folder "data" (myFiles)
    'INSERT YOUR CODE FOLLOWING THE COMMENT ABOVE'
