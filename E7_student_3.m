...
% beta parameter [-]
    ...
    Sbeta_max = 'INSERT VALUE FOR MAXIMUM FILLING OF BETA-STORE Sbeta'; % maximum filling of beta-store (product of soil porosiy 0.3 and soil depth 1000 mm); can be adjusted!
