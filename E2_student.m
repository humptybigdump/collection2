...
% manually select drought event
    drought_begin_colpach = datetime('INSERT YEAR', 'INSERT MONTH', 'INSERT DAY', 00, 00, 00);   % manually select drought begin: 15 days before center of drought period
    drought_end_colpach = datetime('INSERT YEAR', 'INSERT MONTH', 'INSERT DAY', 00, 00, 00);     % manually select drought end: 15 days after center of drought period
