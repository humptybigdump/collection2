%% Time series analyis, Part 1. Water and Energy Cycles WS 22/23
...
% SCRIPT OR VARIABLE NAME! Ignore warnings in the command window.
...
% calculate monthly runoff sums
for i = 1:12
    monthly_runoff_sum_Colpach(i) = sum(hourly_runoff_Colpach(months == i)); 
...
% calculate the yearly sum of runoff and precipitation
    RC_Colpach_2013 = 'INSERT CALCULATION OF RUNOFF COEFFICIENT IN COLPACH FOR HYDROLOGICAL YEAR BY INDEXING WITH THE ABOVE YEAR INDEX'
    RC_Schwebich_2013 = 'INSERT CALCULATION OF RUNOFF COEFFICIENT IN SCHWEBICH FOR HYDROLOGICAL YEAR BY INDEXING WITH THE ABOVE YEAR INDEX'
...
% unsorted array "colpach_runoff(year_idx)".
    [sorted_runoff_colpach, ranks_colpach] = 'INSERT "SORT" FUNCTION IN DESCENDING ORDER WITH RUNOFF VALUES IN COLPACH FOR HYDROLOGICAL YEAR';
    [sorted_runoff_schwebich, ranks_schwebich] = 'INSERT "SORT" FUNCTION IN DESCENDING ORDER WITH RUNOFF VALUES IN SCHWEBICH FOR HYDROLOGICAL YEAR';
...
% sort the previously calculated probabilities in ascending order
sorted_prob_colpach = 'INSERT "SORT" FUNCTION IN ASCENDING ORDER WITH PREVIOUSLY CALCULATED EXCEEDANCE PROBABILITIES IN COLPACH';
sorted_prob_schwebich = 'INSERT "SORT" FUNCTION IN ASCENDING ORDER WITH PREVIOUSLY CALCULATED EXCEEDANCE PROBABILITIES IN SCHWEBICH';
