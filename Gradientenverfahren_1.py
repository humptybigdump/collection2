...
#f = -2*x*y - y + x**2 + 2*y**2 #Aufgabe "Gradientenverfahren"
f = -4*x - 2*y - x**2 + x**4 + 2*x*y +y**2 #Aufgabe "Gradientenverfahren Newtonverfahren"
...
#print(fct(f, x_arg, y_arg))
#print(grad(f, x_arg, y_arg))