...
% read in data text file with year and HQ value as table (function "readtable")
...
% define an array from 0 to max HQ with step/bin size 100; this array defines the left and right edges of all bins
    'INSERT YOUR CODE FOLLOWING THE COMMENT ABOVE'
...
% Step 1: function "fitdist" to fit a normal cdf to sorted HQ data to find mean and standard deviation as input for generating a normal cdf
