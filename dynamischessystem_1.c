...
int main(int argc, char* argv[]) {
  ...
  solve(0.1,   t_ende, x_start, raeuber, beute, runge_kutta4, "RK2_dt01.dat");
  solve(0.01,  t_ende, x_start, raeuber, beute, runge_kutta4, "RK2_dt001.dat");
  solve(0.001, t_ende, x_start, raeuber, beute, runge_kutta4, "RK2_dt0001.dat");
