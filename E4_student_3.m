...
figure
plot('INSERT YOUR CODE FOLLOWING THE COMMENT')
xlabel('year');
ylabel('HQ [m/s]');
title('HQ time series')

% basic statistics of HQ time series (use functions: max, min, median)
% hint: use logical array indexing to find the date for these values
max_HQ = 'INSERT YOUR CODE FOLLOWING THE COMMENT'
date_max_HQ = 'INSERT YOUR CODE FOLLOWING THE COMMENT'

min_HQ = 'INSERT YOUR CODE FOLLOWING THE COMMENT'
date_min_HQ = 'INSERT YOUR CODE FOLLOWING THE COMMENT'

median_HQ = 'INSERT YOUR CODE FOLLOWING THE COMMENT'
...
bin_edges = 'INSERT YOUR CODE FOLLOWING THE COMMENT'

% plot histogram (function: "histogram")
% hint: check doc histogram for the input for the command
figure
histogram('INSERT YOUR CODE FOLLOWING THE COMMENT')
...
sorted_HQ = 'INSERT YOUR CODE FOLLOWING THE COMMENT'
...
N = 'INSERT YOUR CODE FOLLOWING THE COMMENT'
PE = 'INSERT YOUR CODE FOLLOWING THE COMMENT'
