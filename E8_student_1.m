...
% array should contain two columns: 1. column ->  max(Q_out) values; 2.column -> max(h)
% values.
...
% function "min".
    'INSERT FINDING OF MINIMUM COST "min_cost" OF ALL VALID MC RUNS AND ITS RESPECTIVE POSITION/INDEX "pos_min_cost"'
