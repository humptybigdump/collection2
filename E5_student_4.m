...
% function_input2,...)
    QLR = HBV_function(ET_hourly, ntime, 'INSERT ARRAY WITH OBSERVED PRECIPITATION IN YEAR', 'INSERT VALUE OF INITIAL FILLING OF BETA-STORE', 'INSERT MAXIMUM FILLING OF BETA-STORE', 'INSERT BETA PARAMETER', 'INSERT VALUE OF INITIAL FILLING OF LINEAR RESERVOIR', 'INSERT kLR PARAMETER');
...
% calibrated parameters, which produced this best NSE value.
    'INSERT INDEXING OF "kLR_range" ARRAY BY ABOVE DEFINED "highest_NSE_pos" VALUE TO FIND RESPECTIVELY BEST "kLR" value'
    'INSERT INDEXING OF "beta_range" ARRAY BY ABOVE DEFINED "highest_NSE_pos" VALUE TO FIND RESPECTIVELY BEST "beta" value'
    'INSERT INDEXING OF "Sbeta_initial_range" ARRAY BY ABOVE DEFINED "highest_NSE_pos" VALUE TO FIND RESPECTIVELY BEST "Sbeta_initial" value'
    'INSERT INDEXING OF "SLR_initial_range" ARRAY BY ABOVE DEFINED "highest_NSE_pos" VALUE TO FIND RESPECTIVELY BEST "SLR_initial" value'
...
pos_MC_above_NSE = 'INSERT FINDING OF MC RUNS WITH NSE > 0.8'
...
'INSERT ROUTINE FOR PLOTTING THE SIMULATED HYDROGRAPHS OF ALL THESE SELECTED RUNS IN ONE PLOT, TOGETHER WITH THE OBSERVED HYDROGRAPH'
