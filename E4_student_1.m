...
% respective letter into the follwoing array "soil". IMPORTANT: The letters
...
ths = 'INSERT SAME SYNTAX AS BEFORE FOR ths OF THREE SOIL TYPES';   % ths = Porosity of the soil, water content at saturation
alpha = 'INSERT SAME SYNTAX AS BEFORE FOR alpha OF THREE SOIL TYPES';  % alpha = Air entry value in 1/m (inverted)
n_vg = 'INSERT SAME SYNTAX AS BEFORE FOR n_vg OF THREE SOIL TYPES';  % n_vg = width of the pore size distribution
ks= 'INSERT SAME SYNTAX AS BEFORE FOR ks OF THREE SOIL TYPES'; % ks = saturated hydraulic conductivity, in m/s
m_vg = 1 - 1./n_vg;
